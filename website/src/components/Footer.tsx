      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="my-8 flex flex-wrap justify-center gap-6">
          {NAV_ITEMS.map((item) => (
            <a
              ...
              className="block text-muted duration-150 hover:text-foreground"
            >
        ...
        <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
          <a
            ...
            className="text-muted duration-150 hover:text-foreground"
          >
            <svg
              className="size-6"
        ...
        <div className="text-left text-sm text-muted">
          <span className="block">
            &copy; {new Date().getFullYear()} Focus Reader, All rights reserved
          </span>
